...
import 'package:neurofriend/src/db/payment/midtrans_api.dart';
import 'package:neurofriend/src/db/payment/payment_db_api.dart';
...
import 'package:neurofriend/src/reusable_func/form_validator.dart';
                            ...
                            children: [
                              ...
                              Text(
                                AppLocalizations.of(context)!
                                    ...
                                    'Your donation means so much for our kids in need\n(Donation will be managed by Neurofriend team and will be forwarded to neurodivergent kids in need)',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: isDarkMode
                                      ? const Color.fromARGB(255, 211, 227, 253)
