...
import 'package:neurofriend/src/reusable_func/file_picking.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Markdown(
              ...
              shrinkWrap: true,
              physics: const NeverScrollableScrollPhysics(),
              data: content.parts != null && content.parts!.isNotEmpty
                  ? content.parts!
                      .map((part) => _extractTextFromPart(part))
                      .join('\n')
...
// ...existing code...
            ...
            TextButton.icon(
              onPressed: () {
                final textToCopy = _extractTextFromParts(content.parts);
  ...
  String _extractTextFromPart(Part part) {
    if (part is TextPart) {
      return part.text;
    }
    return '';
  ...
  String _extractTextFromParts(List<Part>? parts) {
    ...
    return parts.map((part) => _extractTextFromPart(part)).join('\n');
  }
}
